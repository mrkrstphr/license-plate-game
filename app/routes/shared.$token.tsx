  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-app)" }}>
      <div className="sticky top-0 z-50">
        ...
        {/* Game summary (mode badge folded in, so there's only one sticky element to position) */}
        <div className="px-4 py-3 border-b shadow-md" style={{ background: "var(--bg-card)", borderColor: "var(--border)" }}>
